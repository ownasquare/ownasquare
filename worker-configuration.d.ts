/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ab04a8ce748b8548dbaa4a0fb1a53d19)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTACT_RECIPIENT">> {}
}
